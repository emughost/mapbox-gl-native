...
TEST(GeometryBuffer, BufferForLine) {
     static const std::string line = R"data({
           ...
           const mapbox::geometry::point<double> a(24.93696391582489, 60.16926456940512), b( 24.938240647315975, 60.16974755943638);
...
TEST(GeometryBuffer, BufferForLines) {
    static const std::string lines = R"data({
          ...
          const mapbox::geometry::point<double> a1(24.93696391582489, 60.16926456940512), b1( 24.938240647315975, 60.16974755943638);
        ...
        const mapbox::geometry::point<double> a2(24.93122935295105,
        60.167383242200444), b2(   24.931269586086273,
                      60.16739658532588);
